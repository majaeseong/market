...
<body>
	<div class="list">
		<div class="list_title">연탄구이 주문 리스트</div>
		...
		<div class="list_count">
			<div>
				닭발 : <span id="foot"></span>
			</div>
			<div>
				목살 : <span id="neck"></span>
			</div>
			<div>
				발+목 : <span id="foot_neck"></span>
			</div>
			<div>
				똥집 : <span id="ddongjip"></span>
			</div>
			<div>
				석쇠구이 : <span id="sucksoi"></span>
			</div>
		</div>
			...
			$.get(url, function(data, status) {
				...
				data.forEach(function(obj) {
					$("#myTable > tbody:last").append(
							"<tr><td>" + obj.order_id + "</td>" + "<td>"
									+ obj.mname + "</td>" + "<td>"
									+ obj.quantity + "</td>" + "<td>"
									+ "<button onclick='finish_order(" + obj.id
